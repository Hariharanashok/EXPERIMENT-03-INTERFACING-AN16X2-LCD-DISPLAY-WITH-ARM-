...
{
	Lcd_cursor(&lcd,0,1);
	Lcd_string(&lcd,"HARIHARAN A\n");
	Lcd_cursor(&lcd,1,1);
	Lcd_string(&lcd,"212222100012");
...
## Output screen shots of proteus  :
 ![image](https://github.com/user-attachments/assets/8b5a0867-bda0-41e6-a4ad-99a5f5ed973a)

 
 ## CIRCUIT DIAGRAM (EXPORT THE GRAPHICS TO PDF AND ADD THE SCREEN SHOT HERE): 
 ![image](https://github.com/user-attachments/assets/664d9e78-c105-4c63-8479-aa7bbe0d1c39)
